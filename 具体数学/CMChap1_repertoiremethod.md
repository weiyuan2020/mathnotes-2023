...
[]{#tab:rnCompare label="tab:rnCompare"}
...
[]{#tab:casesofgene label="tab:casesofgene"}
...
Summations Recurrence like these $\left\{
    \begin{array}{ll}
        r_0 &= \alpha \\
        r_n &= r_{n-1}+\beta n+\gamma \\
    \end{array}
...
[]{#tab:casesofharder label="tab:casesofharder"}
...
::: {#tab:casesofharderChange003}
  ...
  : generalize the harder cases
:::

[]{#tab:casesofharderChange003 label="tab:casesofharderChange003"}
...
::: {#tab:casesofharderChange}
  ...
  : generalize the harder cases(change)
:::

[]{#tab:casesofharderChange label="tab:casesofharderChange"}
...
[]{#tab:casesofharderChange002 label="tab:casesofharderChange002"}

$$r_n = \alpha A(n)+\beta B(n)$$ $r_n=1$ , $\left\{\begin{array}{l}
    1=\alpha\\
    1=2\cdot 1+\beta n\\
\end{array}\right.$ 这是不可能的。因此$\gamma \neq 0$
