...
\begin{aligned}
1\; 6\; 19\; 44\; 85\end{aligned}

$$

 FIGURE 2.39 The ociahedral numbers.
...
\begin{aligned}
1\; 14\; 51\; 124\; 245\end{aligned}

$$

 FIGURE 2.41 The stella octangula
numbers.
...
\begin{aligned}
    ...
    &\;\; -\frac{6}{6}(n-1)n(2n-1)\\
    &= 16n^3 - 33n^2 + 24n - 6.\end{aligned}

$$

 FIGURE 2.43 The truncated
octabedral numbers.
...
\begin{aligned}
1\;15\;65\;175\end{aligned}

$$

 FiGure 2.45 The rhombic dodecabedral
numbers. .
...
$$
 ...
 Figure 2.46 Building a nexus number.
